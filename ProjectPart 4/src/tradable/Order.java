...
public class Order implements Tradable {
    ...
    public Order(String user, String product, Price price,int originalVolume, BookSide side) throws InvalidTradableInputException, InvalidPriceException {
        setUser(user);
        setProduct(product);
        setPrice(price);
        setOriginalVolume(originalVolume);  // Validate first
        setSide(side);
    ...
    private void setId(String user, String product, Price price) throws InvalidPriceException, InvalidTradableInputException {
        if( user == null || product == null ){
            throw new InvalidTradableInputException("Invalid user and product");
        }
        if(price == null){
            throw new InvalidPriceException("Price can not be null");
        }
    ...
    public String toString() {
        return String.format("%s %s order for %s: %s, Orig Vol: %d, Rem Vol: %d, Fill Vol: %d, CXL Vol: %d, ID: %s",
